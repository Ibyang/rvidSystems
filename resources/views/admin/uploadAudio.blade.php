...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Upload Audio File</li>
    </ol>
    </ol>
  </section>
  <!--section ends-->
        ...
        <div class="panel panel-info" style="overflow:auto;">
          <div class="panel-heading">
            <h3 class="panel-title">
              <i class="livicon" data-name="upload-alt" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></i> Audio File Uploader
            </h3>
          </div>
          <div class="panel-body" style="padding:0px !important;">
            <div class="col-md-12" style="padding:30px;">
                <form action="{{ route('uploadAudio') }}" class="dropzone" id="myDropzone" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="fallback">
                ...
                <div id="backdiv" style="display: none; text-align: center">
                    <a href="{{ route('audio') }}">All Audio Files Uploaded.... Click Back to Audio Listing</a>
                </div>
            </div>
          </div>
        </div>
  ...
  <script>
      var FormDropzone = function() {
          ...
          Dropzone.options.myDropzone = {
              ...
              acceptedFiles: ".mid,.midi,.wma,.mp3,.mp4,.ogg,.wav,.aac",
              timeout: 10000,
              ...
              init: function() {
                  ...
                  this.on("removedfile", function (file) {
                      $.ajax({
                          ...
                          type: 'GET',
                          url: '/audioDelete/' + file.customName,
                          dataType: 'json',
                      });
                  });

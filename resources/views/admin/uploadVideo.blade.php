        ...
        <div class="panel panel-info" style="overflow:auto;">
          <div class="panel-heading">
            <h3 class="panel-title">
              <i class="livicon" data-name="upload-alt" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></i> Video File Uploader
            </h3>
          </div>
          <div class="panel-body" style="padding:0px !important;">
            <div class="col-md-12" style="padding:30px;">
                <form action="{{ route('uploadVideo') }}" class="dropzone" id="myDropzone" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="fallback">
                ...
                <div id="backdiv" style="display: none; text-align: center">
                    <a href="{{ route('video') }}">All Video Files Uploaded.... Click Back to Video Listing</a>
                </div>
            </div>
          </div>
        </div>
              ...
              init: function() {
                  ...
                  this.on("removedfile", function (file) {
                      $.ajax({
                          ...
                          type: 'GET',
                          url: '/videoDelete/' + file.customName,
                          dataType: 'json',
                      });
                  });

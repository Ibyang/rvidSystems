              ...
              <fieldset>
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="firstname" value="{{ $agent->firstname }}" class="form-control" id="inputFirstName" placeholder="First Name" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="lastname" value="{{ $agent->lastname }}" class="form-control" id="inputLastName" placeholder="Last Name" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="email" name="email" value="{{ $agent->email }}" class="form-control" id="inputEmail" placeholder="Email" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="password" name="password" value="{{ $agent->password }}" class="form-control" id="inputPassword" placeholder="Password" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="password" name="password_confirmation" value="{{ $agent->password }}" class="form-control" id="inputPassword2" placeholder="Retype Password">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="mobile" value="{{ $agent->mobile }}" class="form-control" id="inputMobile" placeholder="Mobile Number" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="group" value="{{ $agent->group }}" class="form-control" id="inputGroup" placeholder="Group" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="name_agency" value="{{ $agent->name_agency }}" class="form-control" id="inputNameAgency" placeholder="Name of Agency" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="address" value="{{ $agent->address }}" class="form-control" id="inputAddress" placeholder="Address" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <select name="state" id="state" class="form-control" >
                        @foreach($states as $state)
                          <option value="{{ $state->state_code }}" {{ rtrim($agent->state) === $state->state_code ? 'selected' : '' }}> {{ $state->state_name }} </option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="postcode" class="form-control" id="postalCode" placeholder="Postal Code" value="{{ $agent->postcode}}">
                    </div>
                  </div>
                </div>
                <!-- Form actions -->

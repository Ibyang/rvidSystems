    ...
    <div class="container">
        ...
        <div class="row m-0">
            <div class="col-sm-8">
                <div class="row make-my-video border-top-0066ff">
                    ...
                    <div class="col-sm h-145">
                        <div class="d-flex justify-content-between">
                            ...
                            <div><button type="submit" class="btn btn-primary bg-0066ff py-1 px-3">Start</button></div>
                        </div>
                ...
                <ol class="make-v-ol pl-2 m-0 ol-0066ff text-justify">
            ...
            <div class="col-sm-4 col-right-0">
                <div class="border-0066ff py-4 px-5">
                    <h5 class="color-0066ff font-weight-bold mb-3">Manual Video</h5>

                    <p class="font-weight-bold text-justify">If you are happy to spend the
                        time, you select and match
                        images to voice over tracks
                        and make the Video just like
                        you want it.</p>
                    <p class="font-weight-bold text-justify">You get to make the decisions
                        and we do the Video

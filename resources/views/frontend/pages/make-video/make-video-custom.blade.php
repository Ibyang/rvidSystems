    ...
    <div class="container">
        ...
        <div class="row m-0">
            <div class="col-sm-8">
                <div class="row make-my-video border-top-ff0033">
                    <div class="col-md-auto">
                        ...
                        <div class="d-inline-block align-bottom">
                            <p class="color-ff0033">Fully <br>Customized <br>Video</p>
                        </div>
                    </div>
                ...
                <ol class="make-v-ol pl-2 m-0 ol-ff0033 text-justify">
                    <li>You go to a confirmation page which asks you to Approve the order;</li>
                    <li>A Customer Service Officer will contact you to facilitate your customised Video. They will
                        together with you and the team to develop your Video (It’s a one-on-one service) by
                        compiling your personalised one-off script, voice-over, any visual effects and other special
                        on-screen content. Your Premium Video production is made to <br>your requirements;</li>
                    <li>Your Video is delivered.</li>
                </ol>
            </div>
            <div class="col-sm-4 col-right-0">
                <div class="border-ff0033 py-4 px-3">
                    <h5 class="color-ff0033 font-weight-bold mb-3">Custom Video</h5>

                    <p class="font-weight-bold text-justify">When the property is special
                    ...
                    <p class="font-weight-bold text-justify">The Video is made to your

  <div class="container">
    <div class="f-page-info">
        <div class="row">
          ...
          <div class="col-sm">
            ...
            <img class="img-fluid" src={{ asset('storage/app/public/sample-thumb.jpg') }} />
          </div>
        </div>
        ...
        <div class="fv-mobile text-center mt-3">
            <div class="border-ccc pt-2">
                <div class="row">
                    <a href="{{ route('use-revid-website') }}"><div class="col-4 pr-0"><i class="link-icon2 li-v3-sites"></i></div>
                    <div class="col-auto align-self-center pl-0"><b>Online Sites</b></div></a>
                </div>
            </div>
            <div class="border-ccc pt-2 my-2">
                <div class="row">
                    <a href="{{ route('use-revid-social-media') }}"><div class="col-4 pr-0"><i class="link-icon2 li-v3-social"></i></div>
                    <div class="col-auto align-self-center pl-0"><b>Social Media</b></div></a>
                </div>
            </div>
            <div class="border-ccc pt-2">
                <div class="row">
        ...
        <div class="fv-web">
            <div class="row text-center f-use-revid-2 font-weight-bold mt-4">
                <div class="col-sm">
                    <a href="{{ route('use-revid-website') }}"><i class="link-icon sites"></i>
                    <p class="m-0">Online<br>Sites</p></a>
                </div>
                <div class="col-sm">
                    <a href="{{ route('use-revid-social-media') }}"><i class="link-icon social"></i>
                    <p class="m-0">Social<br>Media</p></a>
                </div> 
                <div class="col-sm">
                    <a href="{{ route('use-revid-corporate') }}"><i class="link-icon pres"></i>
                    <p class="m-0">Presentations <br>and Corporate</p></a>
                </div>
                <div class="col-sm">
                    <a href="{{ route('use-revid-marketing') }}"><i class="link-icon marketing"></i>
                    <p class="m-0">Marketing Email<br>Promotions</p></a>
                </div>
                <div class="col-sm">
                    <a href="/"><i class="link-icon office"></i>
                    <p class="m-0">Home Opens <br>Office Displays</p></a>
                </div>
    ...
    <div class="row f-video-step mx-0 my-4 fv-web border-bot5 pb-4">
        <div class="col-sm">
            ...
            <form class="f-g-v-form mt-2" action="{{ route('generic-login') }}" method="POST">
                {{ csrf_field() }}
        ...
        <div class="col-sm">
            <div class="row mt-4">
                ...
                <div class="col text-right pr-0">
                    <img class="img-fluid" src={{ asset('storage/app/public/realty-sample-2.jpg') }} /><br>
                    <span>SAMPLE</span>
                </div>
            </div>

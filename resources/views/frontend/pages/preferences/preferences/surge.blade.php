...
<div class="collapse rules-contents" id="Expanded9">
    <div class="rules-arrow2"></div>
    <div class="ExpandForm text-justify bg-fff mb-3 p-3 color-000"> 
        ...
        <p class="mb-0">Alternatively, you can select <b>SURGE ALWAYS ($15 fixed)</b> and <b>RUSH ALWAYS ($45
...
<div class="row m-r-l">
    ...
    <div class="col">
        <div class="custom-control custom-checkbox standard">
            ...
            <label class="custom-control-label my-0" for="customCheck3">Sometimes (Ask Me) <br>(Cost of the Day)</label> 
        </div>
    </div>
</div>
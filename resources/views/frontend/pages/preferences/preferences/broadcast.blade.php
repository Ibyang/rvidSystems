<div class="border-top-999 pt-3 mt-4">
    ...
    <div class="collapse rules-contents @if (Request::segment(1) != 'account') {{'col-8 pl-0'}} @endif" id="Expanded13">
        ...
        <div class="ExpandForm text-justify bg-fff mb-3 p-3"> 
            ...
            <p class="mb-0">This is a value-added service and a fee applies.</p>
        </div>           
    </div>        
    ...
    <div class="font-t-ms"><b>Select Areas</b></div>
    <div class="row m-r-l my-2">
        <div class="col-sm-10 pr-1"><input type="text" name="area" placeholder="Suburb Select/Search" class="form-control"></div>
        <div class="col-sm align-self-center pl-3"><a href="" class="c0066ff font14"><b>Add +</b></a></div>
    </div>
    <div class="my-2"><b>Suburb Selection</b></div>
    <div class="row m-0">
        <div class="email-scroll col-sm-10 h-100 pr-2 pl-0">
            <ul class="mb-0 p-0">
                <li>
                    <div class="row">
...
<div class="d-flex flex-row-reverse border-top-999 pt-4 mt-4">
        <div>
            <button class="btn btn-primary bg-009900 btn-no-border px-5 py-2 b-radius-7"><b>UPDATE</b></button>
        </div>
</div>
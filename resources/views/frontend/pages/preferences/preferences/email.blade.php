<div class="border-top-999 pt-3">
    ...
    <div class="collapse rules-contents" id="Expanded12">
    ...
    <div class="row m-r-l">
            <div class="col-sm-10"><input type="email" name="email" placeholder="Enter Email" class="form-control"></div>
            <div class="col-sm align-self-center"><a href="" class="c0066ff font14"><b>Add +</b></a></div>
    </div>
    <div class="row m-0">
            <div class="col-sm-10 pl-0 pr-2">
                 <div class="h-100 email-scroll m-0 p-1">
                    <ul>

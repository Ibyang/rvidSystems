            ...
            <form id="frmStep4" method="POST" action="{{ route('account-video-system-processStep4')}}">
                ...
                <div class="register-form">
                    <select name="stateVoiceFormat" class="form-control col-7">
                        <option value="Random Voice(Standard)" {{ $voice['voice_format'] === 'Random Voice' ? 'selected' : '' }}>Random Voice</option>
                        <option value="One Voice" {{ $voice['voice_format'] === 'One Voice' ? 'selected' : '' }}>One Voice</option>
                        <option value="Rotation Voice" {{ $voice['voice_format'] === 'Rotated Voice' ? 'selected' : '' }}>Rotated Voice</option>
                    </select>
                </div>
                ...
                <div class="register-form">
                    <select name="stateMusicStyle" class="form-control col-7">
                        <option value="Random Music(Standard)" {{ $music['music_style'] === 'Random Music Tracks' ? 'selected' : '' }}>Random Music Tracks</option>
                        <option value="One Music" {{ $music['music_style'] === 'Same Music for all my Videos' ? 'selected' : '' }}>Same Music for all my Videos</option>
                        <option value="Rotation Music" {{ $music['music_style'] === 'Rotate My Music' ? 'selected' : '' }}>Rotate My Music</option>
                    </select>
                </div>
                <div class="row">
              ...
              <div class="float-r mt-3 mb-5">
                    <button class="btn btn-primary" type="submit">SAVE : Next Step 5<i class="arrow-right"></i></button>
              </div>

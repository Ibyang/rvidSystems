                ...
                <div class="row m-r-l">
                    <div class="col-sm-8 select-form">
                         ...
                         <select name="stateMusicStyle" class="col-11 form-control mt-2 mb-4">
                            <option value="Random Music Tracks" {{{ (isset($music['music_style']) && $music['music_style'] == 'Random Music Tracks') ? "selected=\"selected\"" : "" }}}>Random Music Tracks</option>
                            <option value="Same Music for all my Videos" {{{ (isset($music['music_style']) && $music['music_style'] == 'Same Music for all my Videos') ? "selected=\"selected\"" : "" }}}>Same Music for all my Videos</option>
                            <option value="Rotate My Music" {{{ (isset($music['music_style']) && $music['music_style'] == 'Rotate My Music') ? "selected=\"selected\"" : "" }}}>Rotate My Music</option>
                        </select>
                    </div>
                </div>
                <div class="row m-r-l">

...
@section('content')
    <div class="container pb-0" id="content">
        ...
        <div class="row">
            <div class="col-sm-8 mb-3">
                ...
                <div class="">
                    <a href="" data-toggle="modal" data-target="#WhatisDrivebyVideoModal"><img class="img-fluid pt-4" src={{ asset('storage/app/public/what-is-driveby2.jpg') }} /></a>
                </div>
            </div>
    ...
    <!-- Video Modal for What is DriveBy -->
    <div class="modal fade" id="WhatisDrivebyVideoModal"
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#WhatisDrivebyVideoModal').on('shown.bs.modal', function () {
                $('body').addClass('test');
                $('#video1')[0].play();
            })

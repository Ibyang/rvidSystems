        ...
        <div class="col-lg-9 my-account-form"><br>
            ...
            <form method="POST" action="{{ route('postVideoOrder') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                         <input type="text" class="form-control" name="url" required autofocus value="{{ $url_generic }}">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                 <input type="text" class="form-control" id="total_cost" name="total_cost" required autofocus value="{{ number_format($total_cost,2) }}" style="text-align: right" readonly>
                            </div>
                        </div>
                    </div>
                </div>

      ...
      <div class="col-lg-4">
        ...
        <div class="col-lg-8 make-video-con">
            ...
            <div class="px-3 my-5">
                <div class="row make-my-video border-top-6600cc">
                        <div class="col-sm-4">
                                ...
                                <div class="d-flex justify-content-start">
                                        ...
                                        <div class="pl-3 align-self-center"><p class="color-6600cc mb-0">We Build <br>your <br>Video</p></div>
                                </div>
                        </div>
                ...
                <div class="row make-my-video border-top-0066ff py-4 my-4">
                        ...
                        <div class="col-sm h-145">
                            ...
                            <div class="row f-s-video text-center mt-2 h-100">
                                <div class="col-sm">

        ...
        <div class="col-lg-8 my-account-form">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('account-update-voiceovers') }}">
                    ...
                    <select name="stateVoiceFormat" class="form-control">
                        <option value="Random Voice" {{ $voice['voice_format'] === 'Random Voice' ? 'selected' : '' }}>Random Voice</option>
                        <option value="One Voice" {{ $voice['voice_format'] === 'One Voice' ? 'selected' : '' }}>One Voice</option>
                        <option value="Rotated Voice" {{ $voice['voice_format'] === 'Rotated Voice' ? 'selected' : '' }}>Rotated Voice</option>
                    </select>

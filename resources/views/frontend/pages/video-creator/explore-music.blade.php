    ...
    <div class="row my-account-container">
      <div class="col-lg-4">
        ...
        <div class="col-lg-8 my-account-form mb-5">
                <h3 class="my-account-title mb-3">Music Selection</h3>
                ...
                <div class="row mb-4 m-r-l font14">
                    <div class="col-sm-auto">
                        ...
                        <div>We Pick <b>Random</b> <br>Music for Your Videos</div>
                    </div>
                    <div class="col-sm-auto border-left-right-ccc">
                        <div class="mx-auto">
                            <div class="c0066ff font-weight-bold">2. ONE MUSIC TRACK</div>
                            <div>You use the <b>Same</b> Music <br>for <b>ALL</b> Your Videos</div>
                        </div>
                    </div>
                ...
                <div class="row m-r-l">
                    <div class="col-sm-8 select-form">
                         <select name="music_style" class="col-11 form-control mt-2 mb-4">
                              <option value="Random Music(Standard)" {{ $music['music_style'] === 'Random Music' ? 'selected' : '' }}>Random Music</option>
                              <option value="One Music" {{ $music['music_style'] === 'One Music' ? 'selected' : '' }}>One Music</option>
                              <option value="Rotated Music" {{ $music['music_style'] === 'Rotated Music' ? 'selected' : '' }}>Rotated Music</option>
                          </select>
                    </div>
                </div>
                <div class="row m-r-l">

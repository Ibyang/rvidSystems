      ...
      <div class="border-bot4">   
        <div class="row">
            <div class="col-sm-8 mb-3">
                ...
                <div>
                    <a href="" data-toggle="modal" data-target="#WhatisRevidVideoModal"><img class="img-fluid pt-4" src={{ asset('storage/app/public/revid-video.jpg') }}></a>
                </div>
            </div>
            <div class="col-sm-4 text-center">
                ...
                (Get started today)
                <div class="mt-3">
                    <a href="" data-toggle="modal" data-target="#HowtoJoinVideoModal"><img class="img-fluid" src={{ asset('storage/app/public/how-to-join.jpg') }} /></a>
                    <div class="m-35-0">
                        <h1 class="c-6600cc m-0">How the system works?</h1>
                        (It’s easy)
                    </div>
                    <a href="" data-toggle="modal" data-target="#HowSystemWorksVideoModal"><img class="img-fluid" src={{ asset('storage/app/public/how-system-works.jpg') }} /></a>
                </div>
            </div>
        </div>
       </div> 
        ...
        <div class="modal-dialog" role="document" style="max-width: 700px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center><iframe width="480" height="270" src="https://www.youtube.com/embed/IzrSCHPwPEY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></center>

        ...
        <div class="border-bot4">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <a href="" data-toggle="modal" data-target="#HowtoJoinVideoModal"><img class="img-fluid pt-4" src={{ asset('storage/app/public/how-to-join-video.jpg') }} ></a><br><br>
                </div>
                <div class="col-sm-4 text-center">
                    ...
                    <a href="" data-toggle="modal" data-target="#HowSystemWorksVideoModal"><img class="img-fluid pt-3" src={{ asset('storage/app/public/how-system-works.jpg') }} /></a>
                </div>
            </div>
        </div>

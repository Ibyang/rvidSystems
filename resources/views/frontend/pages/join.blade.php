...
@section('content')
    <div class="container" id="content">
        ...
        <div class="row">
          ...
          <div class="col-4">
              <h1 class="c-6600cc" style="text-align: center; margin-bottom: 10px">How to use REVid<br>in your business?</h1>
              <a href="" data-toggle="modal" data-target="#RevidBusinessVideoModal"><img src={{ asset('storage/how-to-join.jpg') }} /></a>
              <br><br><h1 class="c-6600cc" style="text-align: center; margin-bottom: 0">How the system works?</h1>
              <p style="text-align: center">(It’s easy)</p>

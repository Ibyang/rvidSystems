...
@section('content')
    <div class="container pb-0" id="content">
        ...
        <div class="row mb-4">
            <div class="col-sm">
                <p class="text-justify line-height20"><b>DriveBy</b> uses smartphone geolocation to turn your For-Sale signboard into a “See Inside Now” experience by identifying location and playing the property video on demand.
                    ...
                    <br><br>
                    It’s simple to use as no “App” is needed and delivers satisfying property information in your brand – allowing the tpotential buyers to engage immediately with the property and the agent.</p>
            </div>
            <div class="col-md-auto">
                <a href={{ route('driveby-video') }}><img class="img-fluid" src="{{ asset('storage/what-is-driveby3.jpg') }}"></a>
            </div>
        </div>
        <div class="border-top-bot-999 py-4 look-first mb-r">
            ...
            <div class="text-center my-4"><button class="btn btn-primary col-sm-3 font-weight-bold">SEE INSIDE NOW</button></div>
        </div>

...
@section('content')
    ...
    <div class="container" id="content">
            ...
            <h3 class="header-border font-weight-bold color-424244">Terms and Conditions</h3>
            <div class="row">
                ...
                <div class="col-2 align-self-center color-666"><a href="{{ url('account/getDocumentPDF/1') }}" style="color: #666666"><i class="dl-pdf"></i> Download PDF</a></div>

...
@section('content')
    <div class="container" id="content">
        ...
        <div class="row">
          <div class="col-8">
              <h1 class="c-6600cc">What is LookFirst? Video</h1>
              <a href="" data-toggle="modal" data-target="#WhatisLookFirstVideoModal"><img src={{ asset('storage/look-first-video.jpg') }} /></a>
          </div>
          <div class="col-4 text-center">
              <h1 class="c-6600cc m-0">How to join?</h1>
              <b>(Get started today)</b><br><br>
              <a href="" data-toggle="modal" data-target="#HowtoJoinVideoModal"><img src={{ asset('storage/how-to-join.jpg') }} /></a><br><br>
    ...
    <div class="modal fade" id="WhatisLookFirstVideoModal"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#WhatisLookFirstVideoModal').on('shown.bs.modal', function () {
            $('body').addClass('test');
            $('#WhatisLookFirstVideoModal')[0].play();
        })

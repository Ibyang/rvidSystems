        ...
        <div class="border-bot4">
            <div class="row">
                <div class="col-sm-8 mb-3">
                    ...
                    <div>
                        <a href="" data-toggle="modal" data-target="#HowSystemWorksVideoModal"><img class="img-fluid pt-4" src={{ asset('storage/app/public/how-system-works-video.jpg') }} ></a>
                    </div>
                </div>
                <div class="col-sm-4 text-center">
                    ...
                    <div class="mt-3">
                        ...
                        {{--<a href="/how-system-works"><img class="img-fluid" src={{ asset('storage/app/public/how-system-works.jpg') }} /></a>--}}
                        <a href="" data-toggle="modal" data-target="#HowToUseRevidVideoModal"><img class="img-fluid" src={{ asset('storage/app/public/get-started.jpg') }} /></a>
                    </div>
                </div>
            </div>
        </div>

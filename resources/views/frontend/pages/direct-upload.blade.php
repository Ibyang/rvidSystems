                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="d-flex flex-row">
                                    ...
                                    <input type="text" class="form-control b-radius-0 ml-2 w-100" name="num_bedroom" placeholder="Bedroom">
                                    <!-- <div class="form-control b-radius-0 ml-2 w-100">Bedroom</div> -->
                                </div>
                            </div>
                            <div class="col-sm">
                                 <div class="d-flex flex-row">
                                     <div class="bg-eae p-2"><i class="d-u-icon d-u-icon-bat"></i></div>
                                     <input type="text" class="form-control b-radius-0 ml-2 w-100" name="num_bathrooms" placeholder="Bathrooms">
                                     <!-- <div class="form-control b-radius-0 ml-2 w-100">Bathrooms</div> -->
                                 </div>
                            </div>
                            <div class="col-sm">
                                 <div class="d-flex flex-row">
                                     <div class="bg-eae p-2"><i class="d-u-icon d-u-icon-car"></i></div>
                                     <input type="text" class="form-control b-radius-0 ml-2 w-100" name="num_cars" placeholder="Cars">
                                     <!-- <div class="form-control b-radius-0 ml-2 w-100">Cars</div> -->
                                 </div>
                            </div>
                        </div>

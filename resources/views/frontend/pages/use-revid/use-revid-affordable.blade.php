    ...
    <div class="container pb-0" id="content">
        <div class="row">
            <div class="col-sm col-md-auto pb-3">
                ...
                <a href="" data-toggle="modal" data-target="#RevidAffordableVideoModal"><img class="img-fluid" src={{ asset('storage/app/public/why-use-revid-affordable.jpg') }} /></a>
            </div>
            <div class="col-sm">
                ...
                <ul class="list text-justify ml-4">
                    ...
                    <li><b>REVid productions are very affordable</b> solutions to a professional Video with Voice-over.</li>  
                    <li>Subscription Plans Video costs are:<br> 
                        <div class="row mt-2"> 
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm"><b>$139</b> (including st)</div> 
                        </div> 
                        <div class="row"> 
                    ...
                    <li><b>Casual</b> Access is available with limited functionality</li> 
                </ul>
            </div>
        </div>

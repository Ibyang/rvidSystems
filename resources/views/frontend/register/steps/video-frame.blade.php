        <h3><div class="register-icon reg-frame mb-2"></div><span class="pl-1">Video Frame Templates</span></h3>
                   <div class="row">
                       ...
                       @if($temp != null)
                           <div class="col-sm pl-5 select-form" id="checkboxGroup">
                               <div class="header-title mb-4"><b>Video Frame (Main Frame)</b><br>
                                   Please Click to Select your preferred Main Frame Template</div>
                               <div class="row">
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_main_template_1']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="main_frame[]" id="mainframe1" value="1"
                                   ...
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_main_template_2']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="main_frame[]" id="mainframe2" value="2"
                               ...
                               <div class="row mt-3">
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_main_template_3']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="main_frame[]" id="mainframe3" value="3"
                                   ...
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_main_template_4']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="main_frame[]" id="mainframe4" value="4"
                   ...
                   <div class="row">
                       ...
                       @if($temp != null)
                           ...
                           <div class="col-sm select-form pl-5" id="checkboxGroup">
                               <div class="header-title mb-4">End Frame<br>You have 4 End Frame Template Formats</div>
                               <div class="row">
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_end_template_1']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="end_frame[]" id="endframe1" value="1"
                                                   {{{ (isset($endframe_list) && (in_array('1', $endframe_list))) ? "checked" : ""}}}>
                                           <label class="custom-control-label font12" for="endframe1">Select</label>
                                       </div>
                                   </div>
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_end_template_2']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="end_frame[]" id="endframe2" value="2"
                               ...
                               <div class="row mt-3">
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_end_template_3']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="end_frame[]" id="endframe3" value="3"
                                                   {{{ (isset($endframe_list) && (in_array('3', $endframe_list))) ? "checked" : ""}}}>
                                           <label class="custom-control-label font12" for="endframe3">Select</label>
                                       </div>
                                   </div>
                                   <div class="col-sm">
                                       <img src="{{ asset('storage/template_materials/' . $temp['folder_name'] . '/' . $temp['thumb_end_template_4']) }}"><br>
                                       ...
                                       <div class="custom-control custom-checkbox premium d-inline-block float-r">
                                           <input type="checkbox" class="custom-control-input" name="end_frame[]" id="endframe4" value="4"

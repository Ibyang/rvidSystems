...
<div class="row">
        <div class="col-sm">
                ...
                <textarea placeholder="Agency Name and details (as required)" name="videoAgencyName" class="mt-3 mb-3 textarea-txt">{{$agent['name_agency']}}</textarea>
                <textarea placeholder="Content or Other or Address (Optional)" name="videoContent" class="mt-3 mb-3 textarea-txt">{{$agent['address']}}&nbsp;{{$agent['suburb']}}&nbsp;{{$agent['state']}}</textarea>
        </div>
                      ...
                      <div id="{{ $temp['folder_name'] }}">  
                        <div id="wrapper">
                            ...
                            <div id="content" class="col-md-8 cont">
                                <div class="col-md-12 cont logo"><img src="{{ asset('storage/agency_css/'. $agent['group'] . '/mainframe/2/image/' . $temp['agency_logo']) }}" width="77"></div>
                                <div class="col-md-12 cont">
                            ...
                            <div class="col-md-12 cont">
                                <div id="sidebar">
                                    <div class="col-md-3 cont">
                                        <div class="col-md-12 cont"><img class="img-profile" src="" width="173">
                                        </div>
                                    </div>
                                    <div class="col-md-12 cont logo-cont"><img class="img-logo" src="" width="60"></div>
                                </div>
                                <div id="content" class="col-md-9 cont">
                                    <div class="col-md-12 cont">
                                        <h1 class="profile">{{$agent['firstname']}}&nbsp;{{$agent['lastname']}}</h1>

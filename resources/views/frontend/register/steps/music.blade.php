<h3>
    <div class="d-flex flex-row">
        <div class="register-icon r-i-music mb-2"></div>
        <div class="align-self-center font25 pl-3 font-t-ms">Music Selection</div>
    </div> 
</h3>
...
<<<<<<< HEAD
    ...
    <div class="col-sm mx-auto border-left-right-ccc">
        <div class="mx-auto w-205">
            ...
            <div>You use the <b>Same</b> Music for <br><b>ALL</b> Your Videos</div>
        </div>
    </div>
                      ...
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  ...
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseChilledInfo" role="button" aria-expanded="false" aria-controls="collapseChilledInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseChilledInfo">
                              <p class="mx-3 mt-0 mb-3">
                                  Low-tempo, down-beat, light electronic music. Modern sounding, without the heavy, pounding beats of dance music. Often lots of pads, strings, and light melodic sounds.
                              </p>
                          </div>
                      </div>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>CLASSICAL</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseClassicalInfo" role="button" aria-expanded="false" aria-controls="collapseClassicalInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseClassicalInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseClassical">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioBizet" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/CSS40_Light_02_BIZET_Entracte_to_Act3_Carmen.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioMassenet" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/CSS40_Light_04_MASSENET_Meditation.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioVerdi" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/CSS40_Light_05_VERDI_Libiamo_Ne_Lieti_Calici.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioMozart" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/CSS40_Light_08_MOZART_Divertimento_No2.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioDittersdorf" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/CSS40_Light_11_DITTERSDORF_Andante_in_Eb_Major.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioBach" style="display:none;" src="{{ asset('storage/app/public/revid_music/Classical/OPUZZ_CF_05_BACH_French_Suite_No5_in_G_Allemande.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>COUNTRY</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseCountryInfo" role="button" aria-expanded="false" aria-controls="collapseCountryInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseCountryInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseCountry">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioSuburbanCowboy" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/COR2_C&W3_Suburban_Cowboy.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioMonOncle" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/COR2_C&W4_Mon_Oncle_Alfred.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioLivingRoom" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/GMP_Wooden_03_Living Room_Jam.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioOnTheEdge" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/GMP_Wooden_07_On_the_Edge.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioRockin" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/QCCS_CO18_07_Rockin.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioBluesDiddy" style="display:none;" src="{{ asset('storage/app/public/revid_music/Country/QCCS_CV24_08_Blues_Diddy.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>DANCE AND CLUB</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseDanceInfo" role="button" aria-expanded="false" aria-controls="collapseDanceInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseDanceInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseDanceClub">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioClubMusic" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/AB_club-music-broadcast-bed.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioDanceElevation" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/AB_dance-elevation.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioHighJinks" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/AB_high-jinks.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioHouseMyHome" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/OPUZZ_CH_07_House_My_Home.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioHeavenEarth" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/SCAC_06_Heaven_And_Earth.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioPleasureMe" style="display:none;" src="{{ asset('storage/app/public/revid_music/Dance_Club/SG07-Pleasure_Me.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>EASY LISTENING</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseEasyInfo" role="button" aria-expanded="false" aria-controls="collapseEasyInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseEasyInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseEasyListening">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioFGUkulele" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/AB_fun-guitar-and-ukulele.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioRising" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/AB_rising-up.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioCitrine" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/SCFO_01_Citrine.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioTopDown" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/SCFO_04_Top_Down.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioUtopia" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/SCFO_05_Utopia.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioPacificCoast" style="display:none;" src="{{ asset('storage/app/public/revid_music/Easy_Listening/SM_WW06_Pacific_Coast_Cool.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>FUNK AND SOUL</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseFunkInfo" role="button" aria-expanded="false" aria-controls="collapseFunkInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseFunkInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseFunkSoul">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioSenorFunk" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/Amber04_Senor_Funk.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioTootsie" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/OPUZZ_FE_03_Tootsie.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioGrooveConquest" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/OPUZZ_FE_04_Groove_Conquest.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioLoveCrazy" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/OPUZZ_FE_06_Love_Crazy.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioGettingDown" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/OPUZZ_FE_08_Getting_Down.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioTalkBack" style="display:none;" src="{{ asset('storage/app/public/revid_music/Funk_Soul/OPUZZ_FE_10_Talk_Back.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>JAZZ</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseJazzInfo" role="button" aria-expanded="false" aria-controls="collapseJazzInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseJazzInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseJazz">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioIntoPink" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/COR1_Pop5_Into_the_Pink.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioMelloBossa" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/COR3_Jazz2_Mello_Bossa.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioWaveHello" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/CSS10_Smooth_01_Wave_Hello.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioGiveMe" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/CSS27_RealJazz_05_Give_Me_Five.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioWestCoast" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/CSS27_RealJazz_06_West_Coast_Blues.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioLaidDown" style="display:none;" src="{{ asset('storage/app/public/revid_music/Jazz/OPUZZ_LD_01_Laid_Down.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>LOUNGE AND GROOVE</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseLoungeInfo" role="button" aria-expanded="false" aria-controls="collapseLoungeInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseLoungeInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseLounge">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioDeepChill" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/AB_deep-chill.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioReversal" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/OPUZZ_LD_06_Reversal.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioCruiseMuse" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/OPUZZ_LD_07_Cruise_Muse.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioFluffyTrip" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/SM_DCP04_FluffyTrip.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioAcousticDreams" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/SM_SG15_AcousticDreams.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioYesterdayTheme" style="display:none;" src="{{ asset('storage/app/public/revid_music/Lounge_Grooves/SM_SG16_YesterdaysTheme.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>POP</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapsePopInfo" role="button" aria-expanded="false" aria-controls="collapsePopInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapsePopInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapsePop">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioRefreshed" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/OPUZZ_PM_01_Refreshed.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioPastTimes" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/OPUZZ_PM_03_PastTimes.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioPopTop" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/OPUZZ_PM_04_PopTop.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioNewChemistry" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/OPUZZ_PM_05_NewChemistry.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioAppeaseMe" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/SM_PP01_AppeaseMe.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioSleepOnIt" style="display:none;" src="{{ asset('storage/app/public/revid_music/Pop/SM_PP13_SleepOnIt.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>ROCK</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseRockInfo" role="button" aria-expanded="false" aria-controls="collapseRockInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseRockInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseRock">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioToughTalking" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/COR1_Rock3_ToughTalking.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioBlackWidow" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/OPUZZ_MR_05_BlackWidow.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioVistaPop" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/SCIM_05_Vistapop.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioHarmonicSpark" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/SCIM_06_HarmonicSpark.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioLiberator" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/SCIM_08_Liberator.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioTheWolf" style="display:none;" src="{{ asset('storage/app/public/revid_music/Rock/SCIM_10_TheWolf.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>UPBEAT</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseUpbeatInfo" role="button" aria-expanded="false" aria-controls="collapseUpbeatInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseUpbeatInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseUpbeat">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioAlmostSummer" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/AB_almost-summer.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioBHorizons" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/AB_brilliant-horizons.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioFGuitar" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/AB_fun-guitar-and-ukulele.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioLiveMoment" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/AB_live-the-moment.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioRisingUp" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/AB_rising-up.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioChangeWorld" style="display:none;" src="{{ asset('storage/app/public/revid_music/Upbeat/SCIM_01_ChangeTheWorld.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                      <div class="msc-ctg">
                          <div class="d-flex flex-row py-2 px-2">
                              ...
                              <div class="align-self-center">
                                  <b>URBAN AND HIP HOP</b>
                                  <div><a class="font11 v-s-text pl-0" data-toggle="collapse" href="#collapseUrbanInfo" role="button" aria-expanded="false" aria-controls="collapseUrbanInfo"><i class="voice-icon v-i-info"></i><b>More Information</b><i class="v-i-down"></i><i class="v-i-up"></i></a></div>
                              </div>
                          ...
                          <div class="collapse text-justify font12" id="collapseUrbanInfo">
                              <p class="mx-3 mt-0 mb-3">
...
>>>>>>> ffde0e72edfff07fd2a730d34e80d0599d0c4754
                      ...
                      <div class="collapse msc-ctg-txt px-3 py-2" id="collapseUrban">
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioNewWay" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_CP_09_NewWay.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioGoingPlaces" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_PM_07_GoingPlaces.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioOverShoulder" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_US_01_OverMyShoulder.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioBlink" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_US_03_Blink.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between">
                                            <audio id="audioDownTime" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_US_04_DownTime.mp3') }}" controls controlsList="nodownload"></audio>
                                          ...
                                          <div class="d-flex justify-content-between my-2">
                                            <audio id="audioMappedOut" style="display:none;" src="{{ asset('storage/app/public/revid_music/Urban_Hip_Hop/OPUZZ_US_07_MappedOut.mp3') }}" controls controlsList="nodownload"></audio>
...
<<<<<<< HEAD
                            ...
                            <div class="col-md-12 text-center">
                              <br><h1 class="profile-name" id="vname-popup-main1" style="margin-bottom: 0px"></h1>
                              <h2><span id="vmobile-popup-main1"></span><br>
...
<<<<<<< HEAD
                              ...
                              <div class="col-md-2 header-icon">
                                <div><img src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/' . $temp['folder_name'] . '-shower-icon.png') }}" height=20><span class="ctr grey-txt">0</span></div>
                              </div>
                              <div class="col-md-2 header-icon">
                                <div><img src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/' . $temp['folder_name'] . '-car-icon.png') }}" height=20><span class="ctr grey-txt">0</span></div>
                              </div>
...
<<<<<<< HEAD
                ...
                <div id="secondMFTemplateModal" style="display: none">
                  ...
                  <div class="twb337">
                    <div id="{{ $temp['folder_name'] }}-main-2" class="{{ $temp['folder_name'] }}-main-popup-2"> 
                      ...
                      <div id="wrapper">
                        <!--div class="col-md-12 cont"-->
                          <div id="sidebar" class="col-md-3 cont">
                            ...
                            <div class="col-md-12 text-center">
                              <br><h1 class="profile-name" id="vname-popup-main2" style="margin-bottom: 0px"></h1>
                              <h2><span id="vmobile-popup-main2"></span><br>
                                  <span id="vemail-popup-main2"></span><br><br>
                                  <span id="vwebsite-popup-main2"></h2>
                            </div>
                ...
                <div id="thirdMFTemplateModal" style="display: none">
                  ...
                  <div class="twb337">
                    <div id="{{ $temp['folder_name'] }}-main-3" class="{{ $temp['folder_name'] }}-main-popup-3"> 
                      ...
                      <div id="wrapper">
                        <div id="content" class="col-md-9 cont">
                          ...
                          <div class="col-md-6 info gray content-header">
                            <div class="col-md-2 col-md-offset-1 header-icon">
                              <div><img src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/' . $temp['folder_name'] . '-bed-icon.png') }}" height=20><span class="ctr white-txt">0</span></div>
                            </div>
                            <div class="col-md-2 header-icon">
                              <div><img src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/' . $temp['folder_name'] . '-shower-icon.png') }}" height=20><span class="ctr white-txt">0</span></div>
                            </div>
                            <div class="col-md-2 header-icon">
                              <div><img src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/' . $temp['folder_name'] . '-car-icon.png') }}" height=20><span class="ctr white-txt">0</span></div>
                            </div>
                            <div class="col-md-3 header-text">
                        ...
                        <div id="sidebar" class="col-md-3 cont">
                          ...
                          <div class="col-md-12 text-center">
                            <br><h1 class="profile-name" style="margin-bottom: 0px;" id="vname-popup-main3"></h1>
                            <h2><span id="vmobile-popup-main3"></span><br>
                                <span id="vemail-popup-main3"></span><br><br>
                                <span id="vwebsite-popup-main3"></span>      
                            </h2>
                          </div>
                          <div class="branding-container">
                            <div class="col-md-12 cont">
                    ...
                    <div id="{{ $temp['folder_name'] }}-end-2" class="{{ $temp['folder_name'] }}-end-popup-2">
                        ...
                        <div id="wrapper">
                            ...
                            <div id="content" class="col-md-8 cont" style="margin-top: 0">
                              <div class="col-md-12 cont">
                                <h1 class="profile" id="vname-popup-end1"></h1>
                              </div>
                              <div class="col-md-12 cont logo"><img src="{{ asset('storage/app/public/template_materials/'. $temp['folder_name'] . '/' . $temp['agency_logo']) }}" width="150"></div>
                              <div class="col-md-12 cont">
                                <h2 class="profile">
                                Contact Me Today!<br>
                                <br>
                                    <span id="vmobile-popup-end1"></span><br>
                                    <span id="vemail-popup-end1"></span><br>
                                </h2>
                              </div>
                            </div>
                        </div> <!-- end of wrapper -->
                          ...
                          <div class="col-md-12 cont">
                            <div id="sidebar">
                              <div class="col-md-3 cont">
                                <div class="col-md-12 cont">
                                  <img class="img-profile" src="{{ asset('storage/app/public/template_materials/' . $temp['folder_name'] . '/endframe/1/image/helen-yan.jpg') }}" width="337">
                              </div>
                            </div>
                              <div class="col-md-12 cont logo-cont">
                                <img src="{{ asset('storage/app/public/template_materials/'. $temp['folder_name'] . '/' . $temp['agency_logo']) }}" width="112">
                              </div>
                            </div>
                            <div id="content" class="col-md-9 cont" style="margin-top: 0">
                              <div class="col-md-12 cont">
                                <h1 class="profile" id="vname-popup-end2"></h1>
                              </div>
                              <div class="col-md-12 cont">
                                <h2 class="profile"> Contact Me Today!<br>
                                   <br>
                                    <span id="vmobile-popup-end2"></span><br>
                                    <span id="vemail-popup-end2"></span><br>
                                </h2>
                              </div>
...
<<<<<<< HEAD
                        <div id="content" class="col-md-8 cont" style="margin-top: 0">
                          ...
                          <div class="col-md-12 cont">
                            <h2 class="profile"> Contact Me Today!<br>
                                <br>
                                    <span id="vmobile-popup-end3"></span><br>
                                    <span id="vemail-popup-end3"></span><br>
                              </h2>
                          </div>
                          <div class="col-md-12 cont logo"><img src="{{ asset('storage/app/public/template_materials/'. $temp['folder_name'] . '/' . $temp['agency_logo']) }}" width="112"></div>
                        </div>
                      </div>
                    ...
                    <div id="{{ $temp['folder_name'] }}-end-4" class="{{ $temp['folder_name'] }}-end-popup-4">
                      ...
                      <div id="wrapper">
                        ...
                        <div id="content" class="col-md-8 cont" style="margin-top: 0">
                          <div class="col-md-12 cont logo"><img src="{{ asset('storage/app/public/template_materials/'. $temp['folder_name'] . '/' . $temp['agency_logo']) }}" width="112"></div>
                          <div class="col-md-12 cont">
                            <h1 class="profile" id="vname-popup-end4"></h1>
                          </div>
                          <div class="col-md-12 cont">
                            <h2 class="profile"> Contact Me Today!<br>
                                <br>
                                    <span id="vmobile-popup-end4"></span><br>
                                    <span id="vemail-popup-end4"></span><br>
                              </h2>
                          </div>

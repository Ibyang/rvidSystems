                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <select name="stateVoiceFormat" class="form-control col-8">
                                <option value="Random Voice(Standard)" {{ $template['voice_format'] == 'Random Voice(Standard)' ? 'selected' : '' }}>Random Voice (Standard)</option>
                                <option value="One Voice" {{ $template['voice_format'] == 'One Voice' ? 'selected' : '' }}>One Voice</option>
                                <option value="Rotation Voice" {{ $template['voice_format'] == 'Rotation Voice' ? 'selected' : '' }}>Rotation Voice</option>
                            </select>

            ...
            <div class="col-sm">
                <div class="pricing-data border-666666 pd-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="py-2 pr-4 p-30 mr-3 bg-666">$0/month</div>
                    </div>
                    <div class="row">
                        <div class="col-sm-7">
            ...
            <div class="col-sm">
                <div class="pricing-data border-006 pd-2">
                    ...
                    <div class="row my-2 mx-0 pricing-content">
                        ...
                        <div class="col-sm bg-009 font-weight-bold align-self-center px-2">FREE VIDEO<br>Every 2 Months</div>
                    </div>
                ...
                <div class="pricing-box border-660 pd-3">
                   <div class="pricing-data">
                        ...
                        <div class="row my-2 mx-0 pricing-content">
                            ...
                            <div class="col-sm bg-009 font-weight-bold align-self-center px-2">FREE VIDEO<br>Every 3 Months</div>
                        </div>
                        <div class="row mt-1 mb-2 mx-0 pricing-content">
                            <div class="col-sm-3"><b>Video <br>Production <br>Costs</b></div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center">
                            <div class="custom-control custom-checkbox casual">
                              ...
                              <label class="custom-control-label font-weight-bold" for="customCheck4">Select Custom</label>
                            </div>
                        </div>

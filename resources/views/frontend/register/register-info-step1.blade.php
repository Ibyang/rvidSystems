 <div class="row register-info">
          <div class="col-md-auto">
            ...
            <div class="row text-center">
                <div class="col-md-auto">
                    <i class="register-iconstep1 details"></i><br>
                ...
                <div class="col-md-auto">
                    <i class="register-iconstep1 my-tmpt"></i><br>
                ...
                <div class="col-md-auto">
                     <i class="register-iconstep1 pref"></i><br>
                ...
                <div class="col-md-auto">
                     <i class="register-iconstep1 payment"></i><br>
          ...
          <div class="col-md-auto text-center">
                ...
                <div class="row register-col2">
                    <div class="col-sm">
                        <i class="register-iconstep1 rvd"></i><br>
                        <p>REVid<br><b>Ready<br>To Go</b></p>
                    </div>
                    <div class="col-sm">
                        <i class="register-iconstep1 db"></i><br>
                        <p>DriveBy<br><b>Ready<br>To Go</b></p>
                    </div>
                    <div class="col-sm">
                        <i class="register-iconstep1 lf"></i><br>

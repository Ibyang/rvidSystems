    ...
    @if(!empty($details))
        ...
        <div class="row">
            <div class="col-sm">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <textarea id="name" type="text" class="form-control" name="address" required autofocus>{{ $details->address }}</textarea>
            ...
            <div class="col-sm">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <input id="name" type="text" class="form-control" name="name_agency" required value="{{ $details->name_agency }}">
                            @if ($errors->has('name'))
                                    <span class="help-block">
                                            <strong>{{ $errors->first('name') }}</strong>
                                    </span>
        ...
        <form class="form-horizontal" method="POST" action="{{ route('registerAgent.store') }}">
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <textarea id="name" type="text" class="form-control" name="address" placeholder="Address" required autofocus></textarea>
                ...
                <div class="col-sm">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <input id="name" type="text" class="form-control" name="name_agency" required autofocus placeholder="Name Of Agency">
                        @if ($errors->has('name'))
                            <span class="help-block">
                                        <strong>{{ $errors->first('name') }}</strong>
                                </span>

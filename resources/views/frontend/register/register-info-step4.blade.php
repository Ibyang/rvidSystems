 <div class="row register-info">
          <div class="col-md-auto">
            ...
            <div class="row text-center">
                <div class="col-md-auto">
                    <i class="register-iconstep4 details"></i><br>
                ...
                <div class="col-md-auto">
                    <i class="register-iconstep4 my-tmpt"></i><br>
                ...
                <div class="col-md-auto">
                     <i class="register-iconstep4 pref"></i><br>
                ...
                <div class="col-md-auto">
                     <i class="register-iconstep4 payment"></i><br>
          ...
          <div class="col-md-auto text-center">
                ...
                <div class="row register-col2">
                    <div class="col-sm">
                        <i class="register-iconstep4 rvd"></i><br>
                        <p>REVid<br><b>Ready<br>To Go</b></p>
                    </div>
                    <div class="col-sm">
                        <i class="register-iconstep4 db"></i><br>
                        <p>DriveBy<br><b>Ready<br>To Go</b></p>
                    </div>
                    <div class="col-sm">
                        <i class="register-iconstep4 lf"></i><br>

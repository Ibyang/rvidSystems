...
=======
    ...
    <li>
        <i class="account-icon my-creator @if (Request::segment(2) == 'make-video') {{'my-creator-active'}} @else {{'my-creator'}} @endif"></i>
        <a href="{{ route('account-make-video') }}" class="@if (Request::segment(2) == 'make-video') {{'c-ff0033'}} @endif">Make Video</a>
    </li>
    <li>
    ...
    <li>
        ...
        <div class="collapse" id="Sidebar">
            <div class="d-flex flex-column setting-sidebar">
                <div class="mt-2"><a href="{{ route('account-explore-templates') }}" class="@if (Request::segment(3) == 'explore-templates') {{'c-ff0033'}} @endif">Templates</a></div>
                <div class="my-3"><a href="{{ route('account-explore-pictures') }}" class="@if (Request::segment(3) == 'explore-pictures') {{'c-ff0033'}} @endif">Pictures</a></div>
                <div><a href="{{ route('account-explore-voice-overs') }}" class="@if (Request::segment(3) == 'explore-voice-overs') {{'c-ff0033'}} @endif">Voice Overs</a></div>
                <div class="my-3"><a href="{{ route('account-explore-music') }}" class="@if (Request::segment(3) == 'explore-music') {{'c-ff0033'}} @endif">Music Selection</a></div>
